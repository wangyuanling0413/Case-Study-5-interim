...
Through the utilization of MICE package, we managed to speficy the imputation model separately for each variable using the other variables as predictors; and set the number of imputed datasets to be 10, in order to limit 
