...
However, due to the high dimensions of the dataframe resulting from the above step (186 rows and 39 columns), it may be more useful to assess missingness in the dataset graphically, using the "aggr()" function of the MICE package. 
